...
* [FEATURE] Server: Add `-server.cluster-verification-label` flag to define the server's cluster verification label. If set, the server rejects requests without a matching label.
