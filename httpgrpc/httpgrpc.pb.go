...
var fileDescriptor_c50820dbc814fcdd = []byte{
	...
	,
	...
	0xe3, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0x38, 0x52, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xaa,
	0x6e, 0xa0, 0x0b, 0x06, 0x02, 0x00, 0x00,
}
...
// HTTP2Client is the client API for HTTP2 service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type HTTP2Client interface {
	Handle(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (*HTTPResponse, error)
}
...
func NewHTTP2Client(cc *grpc.ClientConn) HTTP2Client {
	return &hTTP2Client{cc}
}

func (c *hTTP2Client) Handle(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (*HTTPResponse, error) {
	out := new(HTTPResponse)
	err := c.cc.Invoke(ctx, "/httpgrpc.HTTP2/Handle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// HTTP2Server is the server API for HTTP2 service.
type HTTP2Server interface {
	Handle(context.Context, *HTTPRequest) (*HTTPResponse, error)
}

// UnimplementedHTTP2Server can be embedded to have forward compatible implementations.
type UnimplementedHTTP2Server struct {
}

func (*UnimplementedHTTP2Server) Handle(ctx context.Context, req *HTTPRequest) (*HTTPResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Handle not implemented")
}

func RegisterHTTP2Server(s *grpc.Server, srv HTTP2Server) {
	s.RegisterService(&_HTTP2_serviceDesc, srv)
}

func _HTTP2_Handle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HTTPRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HTTP2Server).Handle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/httpgrpc.HTTP2/Handle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HTTP2Server).Handle(ctx, req.(*HTTPRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _HTTP2_serviceDesc = grpc.ServiceDesc{
	ServiceName: "httpgrpc.HTTP2",
	HandlerType: (*HTTP2Server)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Handle",
			Handler:    _HTTP2_Handle_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "httpgrpc.proto",
