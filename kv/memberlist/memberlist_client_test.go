...
func TestGetBroadcastsPrefersLocalUpdates(t *testing.T) {
	...
	kv.broadcastNewValue("non-local", smallUpdate, 1, codec, false, time.Now())
	kv.broadcastNewValue("non-local", bigUpdate, 2, codec, false, time.Now())
	kv.broadcastNewValue("local", smallUpdate, 1, codec, true, time.Now())
	kv.broadcastNewValue("local", bigUpdate, 2, codec, true, time.Now())
	kv.broadcastNewValue("local", mediumUpdate, 3, codec, true, time.Now())
