...
func (m *KV) createAndRegisterMetrics() {
	...
	// memberlist uses hashimetrics package for internal usage
	// here we configure hashimetrics to use prometheus.
	...
	if err == nil {
		cfg := hashimetrics.DefaultConfig("")
		...
		_, err = hashimetrics.NewGlobal(cfg, sink)
	}
