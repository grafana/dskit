...
// Provenance-includes-location: https://github.com/grafana/mimir/blob/main/pkg/util/propagation/propagation_test.go
...
func testCarrier(t *testing.T, c Carrier) {
	...
	// Non-canonical key lookups must also work.
	require.Equal(t, "bar", c.Get("fOO"))
	require.Equal(t, []string{"bar"}, c.GetAll("fOO"))
