...
type PartitionTokenScheme int32

const (
	// Tokens are stored in the partition descriptor, including an empty token list.
	PartitionTokensStored PartitionTokenScheme = 0
	// 512 spread-minimizing tokens derived from the partition ID in zone 0.
	PartitionTokensSmt512 PartitionTokenScheme = 1
)

var PartitionTokenScheme_name = map[int32]string{
	0: "PartitionTokensStored",
	1: "PartitionTokensSmt512",
}

var PartitionTokenScheme_value = map[string]int32{
	"PartitionTokensStored": 0,
	"PartitionTokensSmt512": 1,
}

func (PartitionTokenScheme) EnumDescriptor() ([]byte, []int) {
...
// PartitionRingDesc holds the stored state of the partitions ring, which may omit tokens.
// Read resolved tokens through PartitionRing; only its build path and writer helpers access stored tokens.
...
type PartitionDesc struct {
	...
	// Immutable stored tokens. Ignored when tokenScheme specifies derived tokens.
	// Read resolved tokens through PartitionRing. Changes to stored tokens are not propagated via memberlist.
	...
	// Immutable token scheme, set at creation. Unset means stored tokens.
	TokenScheme PartitionTokenScheme `protobuf:"varint,7,opt,name=tokenScheme,proto3,enum=ring.PartitionTokenScheme" json:"tokenScheme,omitempty"`
...
func (m *PartitionDesc) GetTokenScheme() PartitionTokenScheme {
	if m != nil {
		return m.TokenScheme
	}
	return PartitionTokensStored
}
...
func init() {
	proto.RegisterEnum("ring.PartitionTokenScheme", PartitionTokenScheme_name, PartitionTokenScheme_value)
...
var fileDescriptor_4df2762174d93dc4 = []byte{
	...
	,
}

func (x PartitionTokenScheme) String() string {
	s, ok := PartitionTokenScheme_name[int32(x)]
	if ok {
		return s
	}
...
func (this *PartitionDesc) Equal(that interface{}) bool {
	...
	if this.TokenScheme != that1.TokenScheme {
		return false
	}
...
func (this *PartitionDesc) GoString() string {
	...
	s = append(s, "TokenScheme: "+fmt.Sprintf("%#v", this.TokenScheme)+",\n")
...
func (m *PartitionDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TokenScheme != 0 {
		i = encodeVarintPartitionRingDesc(dAtA, i, uint64(m.TokenScheme))
		i--
		dAtA[i] = 0x38
	}
...
func (m *PartitionDesc) Size() (n int) {
	...
	if m.TokenScheme != 0 {
		n += 1 + sovPartitionRingDesc(uint64(m.TokenScheme))
	}
	return n
}
...
func (this *PartitionDesc) String() string {
	...
	s := strings.Join([]string{`&PartitionDesc{`,
		...
		`TokenScheme:` + fmt.Sprintf("%v", this.TokenScheme) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PartitionDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TokenScheme", wireType)
			}
			m.TokenScheme = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TokenScheme |= PartitionTokenScheme(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
