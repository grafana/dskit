...
const (
	...
	// via memberlist the information that a partition has been deleted. Partitions in this state
...
type PartitionDesc struct {
	...
	// Timestamp (with seconds precision) of when has the state changed last time for this partition.
...
// Owner holds the information of a partition owner.
type OwnerDesc struct {
	// Timestamp (with seconds precision) of when the data for the owner has been updated the last time.
	...
	OwnedPartition int32 `protobuf:"varint,3,opt,name=ownedPartition,proto3" json:"ownedPartition,omitempty"`
}
...
var fileDescriptor_4df2762174d93dc4 = []byte{
	...
	,
}
