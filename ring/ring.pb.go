...
type InstanceDesc struct {
	...
	// Unix timestamp (with seconds precision) of when the instance was marked as "read-only".
	// If instance is not read-only, this value is 0.
	// Read-only instances go through standard state changes, and special handling is applied to them
	// during shuffle shards.
	ReadonlyTimestamp int64 `protobuf:"varint,10,opt,name=readonly_timestamp,json=readonlyTimestamp,proto3" json:"readonly_timestamp,omitempty"`
}
...
func (m *InstanceDesc) GetReadonlyTimestamp() int64 {
	if m != nil {
		return m.ReadonlyTimestamp
	}
	return 0
}
...
var fileDescriptor_26381ed67e202a6e = []byte{
	...
	,
}
...
func (this *InstanceDesc) Equal(that interface{}) bool {
	...
	if this.ReadonlyTimestamp != that1.ReadonlyTimestamp {
		return false
	}
	return true
}
...
func (this *InstanceDesc) GoString() string {
	...
	s = append(s, "ReadonlyTimestamp: "+fmt.Sprintf("%#v", this.ReadonlyTimestamp)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *InstanceDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ReadonlyTimestamp != 0 {
		i = encodeVarintRing(dAtA, i, uint64(m.ReadonlyTimestamp))
		i--
		dAtA[i] = 0x50
	}
	if len(m.Id) > 0 {
...
func (m *InstanceDesc) Size() (n int) {
	...
	if m.ReadonlyTimestamp != 0 {
		n += 1 + sovRing(uint64(m.ReadonlyTimestamp))
	}
	return n
}
...
func (this *InstanceDesc) String() string {
	...
	s := strings.Join([]string{`&InstanceDesc{`,
		...
		`ReadonlyTimestamp:` + fmt.Sprintf("%v", this.ReadonlyTimestamp) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *InstanceDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadonlyTimestamp", wireType)
			}
			m.ReadonlyTimestamp = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRing
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadonlyTimestamp |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
