...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.UintVar(&cfg.GPRCServerMaxConcurrentStreams, "server.grpc-max-concurrent-streams", 10000, "Limit on the number of concurrent streams for gRPC calls from all clients (0 = unlimited).")
