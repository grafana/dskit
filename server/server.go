...
type Config struct {
	...
	// to connect to any existing trace.
...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&cfg.CreateNewTraces, "server.create-new-traces", false, "Creates new traces for each call rather than continuing the existing trace. A span link is used to allow navigation to the parent trace.")
}
